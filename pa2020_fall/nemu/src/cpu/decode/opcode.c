...
instr_func opcode_entry[256] = {
    ...
    /* 0x8c - 0x8f*/ mov_s2rm, lea_m2r_v, mov_rm2s, inv,
    ...
    /* 0xa8 - 0xab*/ test_al, test_eax, stos_b, stos_v,
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, ret_neari, ret_near,
    /* 0xc4 - 0xc7*/ inv, inv, mov_i2rm_b, mov_i2rm_v,
    /* 0xc8 - 0xcb*/ inv, leave, inv, inv,
    /* 0xcc - 0xcf*/ 
    #ifdef IA32_INTR
    inv, int_imm, inv, iret,
    #else
    inv, inv, inv, inv,
    #endif
    ...
    /* 0xe8 - 0xeb*/ call_i_near, jmp_near,
                    #ifdef IA32_SEG
                    ljmp,
                    #else
                    inv,
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_near_indirect, call_rm_near, jmp_rm_near, jmp_rm_near, push_rm_v, inv};
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x20 - 0x23*/ mov_c2rm, inv, mov_rm2c, inv,
